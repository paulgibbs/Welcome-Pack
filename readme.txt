...
* IMPORTANT NOTE: Until BuddyPress 1.1 is released, you need to manually apply fix http://trac.buddypress.org/changeset/1477 to your BuddyPress install else not all features will work properly.
