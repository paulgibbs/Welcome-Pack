...
?>
<html>
	<body bgcolor="#f9f9f9" link="#1FB3DD" alink="#1FB3DD" vlink="#1FB3DD" marginheight="0" topmargin="0" marginwidth="0" leftmargin="0" style="margin: 0px; background-color: #f9f9f9; font-family: Helvetica, Arial, sans-serif;">
								...
								<td>
									<div style="border:solid 1px #d9d9d9;">
										<table id="header" width="100%;" border="0" cellpadding="0" bgcolor="#ffffff" cellspacing="0" style="line-height:1.5;font-size:12px;font-family: Helvetica, Arial, sans-serif;border:solid 1px #FFFFFF;">
											...
											<tr >
												...
												<td style="padding: 0 30px 0 0;" align="right" valign="baseline">
													<span style="font-size:14px;color:#888888">%blog_description%</span>
												</td>
											</tr>
										</table>
										<table id="content" width="100%;" border="0" cellpadding="0" bgcolor="#ffffff" cellspacing="0" style="color:#555555;line-height:1.5;font-size:12px;font-family: Arial, sans-serif;padding:20px 30px 0 30px;">
											<tr>
										...
										<table id="footer" width="100%;" border="0" cellpadding="0" bgcolor="#ffffff" cellspacing="0" style="line-height:1.5;font-size:12px;font-family: Arial, sans-serif;padding:0 30px 15px 30px;">
											<tr style="font-size:11px;color:#888888;">
												<td style="border-top: solid 1px #d9d9d9;" colspan="2">
													<img style="padding:15px 0 0 0" height="32" width="32" src="%blog_url%/wp-content/plugins/welcome-pack/templates/email_logo.png" align="right" alt="Powered by BuddyPress" />
													...
													<div><img height="12" width="12" style="vertical-align: middle;" src="%blog_url%/wp-content/images/comment-grey-bubble.png" alt="Contact"  /> For any request, please contact <a href="mailto:%admin_email%">%admin_email%</a></div>
												</td>
											</tr>
										</table>
									</div>
