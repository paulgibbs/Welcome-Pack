...
?>
<html>
	<body bgcolor="#f9f9f9" link="#D84800" alink="#D84800" vlink="#D84800" marginheight="0" topmargin="0" marginwidth="0" leftmargin="0" style="margin: 0px; background-color: #f9f9f9; font-family: Helvetica, Arial, sans-serif;">
										...
										<table id="footer" width="100%;" border="0" cellpadding="0" bgcolor="#ffffff" cellspacing="0" style="line-height:1.5;font-size:12px;font-family: Arial, sans-serif;padding:0 30px 15px 30px;">
											<tr style="font-size:11px;color:#777777;">
												<td style="border-top: solid 1px #d9d9d9;" colspan="2">
													<img style="padding:15px 0 0 0" height="32" width="32" src="%blog_url%/wp-content/plugins/buddypress/bp-themes/bp-default/_inc/images/email_logo.png" align="right" alt="Powered by BuddyPress" />
